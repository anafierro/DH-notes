...
import poster from '../assets/images/mandalorian.jpg';
							...
							<div className="card shadow mb-4">
								...
								<div className="card-body">
									<div className="text-center">
										<img className="img-fluid px-3 px-sm-4 mt-3 mb-4" style={{width:'40 rem'}} src={poster} alt=" Star Wars - Mandalorian " />
									</div>
